...
| M6 Hegemony and AI | Next. Shares and opulence done; trade dependence and tribute now exist, so the trade and force levers can be built. Credit levers need loans and Public Credit. Wars run at a median of 2 a game against a target of 6: coalitions against a leader should add more |
